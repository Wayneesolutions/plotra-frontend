...
const styles = {
  ...
  leadName: { fontWeight: '700', fontSize: '14px', color: '#111827', marginRight: '10px' },
  ...
  waBtn: { padding: '6px 12px', borderRadius: '6px', backgroundColor: '#16a34a', color: '#fff', fontSize: '12px', fontWeight: '600', textDecoration: 'none' },
