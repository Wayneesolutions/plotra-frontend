...
const styles = {
  ...
  title: { margin: 0, fontSize: '16px', color: 'oklch(0.219 0.032 264.2)', fontWeight: '600' },
  closeX: { border: 'none', background: 'none', fontSize: '20px', cursor: 'pointer', color: '#9ca3af' },
  errorBox: { backgroundColor: 'oklch(0.577 0.245 27.325 / 0.06)', color: 'oklch(0.577 0.245 27.325)', padding: '8px 10px', borderRadius: '6px', fontSize: '13px', marginBottom: '12px' },
  ...
  submitBtn: { padding: '9px', border: 'none', backgroundColor: 'oklch(0.317 0.132 285.5)', color: '#fff', borderRadius: '6px', fontWeight: 'bold', cursor: 'pointer', fontSize: '13px' },
  linkedName: { fontSize: '15px', fontWeight: '700', color: 'oklch(0.219 0.032 264.2)', margin: '0 0 6px 0' },
  approveBtn: { padding: '8px 14px', border: '1px solid oklch(0.6 0.13 178.5)', color: 'oklch(0.6 0.13 178.5)', backgroundColor: '#fff', borderRadius: '6px', cursor: 'pointer', fontSize: '12px', fontWeight: '600' },
  rejectBtn: { padding: '8px 14px', border: '1px solid oklch(0.577 0.245 27.325)', color: 'oklch(0.577 0.245 27.325)', backgroundColor: '#fff', borderRadius: '6px', cursor: 'pointer', fontSize: '12px', fontWeight: '600' },
};
