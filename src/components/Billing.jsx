...
const styles = {
  ...
  cardTitle: { margin: '0 0 10px 0', fontSize: '16px', color: '#111827' },
  currentPlan: { fontSize: '18px', fontWeight: '700', color: '#111827', textTransform: 'capitalize', margin: '0 0 4px 0' },
  helpText: { fontSize: '13px', color: '#6b7280', margin: '0 0 12px 0' },
  dangerBtn: { padding: '8px 14px', border: '1px solid #dc2626', color: '#dc2626', backgroundColor: '#fff', borderRadius: '6px', cursor: 'pointer', fontSize: '13px', fontWeight: '600' },
  ...
  planLabel: { fontSize: '13px', fontWeight: '700', color: '#2563eb', marginBottom: '6px' },
  planPrice: { fontSize: '16px', fontWeight: '700', color: '#111827', marginBottom: '10px' },
  primaryBtn: { width: '100%', padding: '8px', border: 'none', backgroundColor: '#2563eb', color: '#fff', borderRadius: '6px', fontWeight: '600', cursor: 'pointer', fontSize: '12px' },
