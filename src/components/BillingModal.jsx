...
const S = {
  ...
  currentPlanValue: { fontSize: '17px', fontWeight: '800', color: 'oklch(0.219 0.032 264.2)', textTransform: 'capitalize' },
  statusPill: { fontSize: '11px', fontWeight: '700', padding: '4px 12px', borderRadius: '999px', textTransform: 'uppercase' },
  statusActive: { backgroundColor: 'oklch(0.78 0.128 178.5 / 0.12)', color: 'oklch(0.6 0.13 178.5)' },
  statusInactive: { backgroundColor: 'oklch(0.7 0.184 33.5 / 0.06)', color: 'oklch(0.6 0.19 40)' },
  ...
  planRowActive: { borderColor: 'oklch(0.7 0.184 33.5)', backgroundColor: 'oklch(0.7 0.184 33.5 / 0.06)' },
  planName: { fontSize: '14px', fontWeight: '700', color: 'oklch(0.219 0.032 264.2)', textTransform: 'capitalize' },
  ...
  cancelBtn: {
    padding: '10px 16px', borderRadius: '9px', border: '1.5px solid oklch(0.577 0.245 27.325 / 0.5)',
    background: '#fff', color: 'oklch(0.577 0.245 27.325)', fontWeight: '700', fontSize: '12px', cursor: 'pointer',
  },
  ...
  historyPlan: { fontWeight: '600', color: 'oklch(0.219 0.032 264.2)', textTransform: 'capitalize' },
  historyDate: { color: '#94a3b8', fontSize: '11px' },
  historyAmount: { fontWeight: '700', color: 'oklch(0.219 0.032 264.2)' },
};
